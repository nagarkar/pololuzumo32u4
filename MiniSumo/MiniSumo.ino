...
static QState Sumo_backoff(Sumo * const me);
static QState Sumo_reverse(Sumo * const me);
static QState Sumo_wait(Sumo * const me);
/*$enddecl${AOs::Sumo} #####################################################*/
...
static QState Sumo_fighting(Sumo * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*${AOs::Sumo::SM::fighting::ON_BOUNDARY} */
        case ON_BOUNDARY_SIG: {
            status_ = Q_TRAN(&Sumo_backoff);
            break;
        }
        default: {
            status_ = Q_SUPER(&QHsm_top);
...
/*${AOs::Sumo::SM::fighting::turn_right} ...................................*/
static QState Sumo_turn_right(Sumo * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${AOs::Sumo::SM::fighting::turn_right} */
        ...
        /*${AOs::Sumo::SM::fighting::turn_right::OPPONENT_ON_LEFT} */
        case OPPONENT_ON_LEFT_SIG: {
            status_ = Q_TRAN(&Sumo_turn_left);
            break;
        }
        /*${AOs::Sumo::SM::fighting::turn_right::OPPONENT_IN_FRONT} */
...
/*${AOs::Sumo::SM::fighting::turn_left} ....................................*/
static QState Sumo_turn_left(Sumo * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${AOs::Sumo::SM::fighting::turn_left} */
        ...
        /*${AOs::Sumo::SM::fighting::turn_left::OPPONENT_ON_RIGHT} */
        case OPPONENT_ON_RIGHT_SIG: {
            status_ = Q_TRAN(&Sumo_turn_right);
            break;
        }
        /*${AOs::Sumo::SM::fighting::turn_left::OPPONENT_IN_FRONT} */
        case OPPONENT_IN_FRONT_SIG: {
            status_ = Q_TRAN(&Sumo_ram);
            break;
        }
...
static QState Sumo_reverse(Sumo * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case Q_ENTRY_SIG: {
            ...
            lcd.print("backoff");
            motors.setSpeeds(-me->turn_speed, -me->turn_speed);
            int timeToReverse = 150 * 3000 /(me->turn_speed);
            QActive_armX((QActive *)me, 0 /*Tick rate */, timeToReverse/* millis */, 0);
            status_ = Q_HANDLED();
            break;
        }
        /*${AOs::Sumo::SM::backoff::reverse::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
            status_ = Q_TRAN(&Sumo_wait);
            break;
        }
        default: {
            status_ = Q_SUPER(&Sumo_backoff);
            break;
        }
    }
    return status_;
}
/*${AOs::Sumo::SM::backoff::wait} ..........................................*/
static QState Sumo_wait(Sumo * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*${AOs::Sumo::SM::backoff::wait} */
        ...
        /*${AOs::Sumo::SM::backoff::wait::IN_RING} */
        case IN_RING_SIG: {
            /*${AOs::Sumo::SM::backoff::wait::IN_RING::[lastturnedleft]} */
            if (me->last_turn == me->LAST_TURN_WAS_LEFT) {
                status_ = Q_TRAN(&Sumo_turn_right);
            }
            /*${AOs::Sumo::SM::backoff::wait::IN_RING::[lastturnedright]} */
            else if (me->last_turn == me->LAST_TURN_WAS_RIGHT) {
                status_ = Q_TRAN(&Sumo_turn_left);
            }
            else {
                status_ = Q_UNHANDLED();
...
static QState LineEvtSimulator_running(LineEvtSimulator * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case Q_TIMEOUT_SIG: {
            unsigned int line_sensor_values[3];
            lineSensors.read(line_sensor_values);

            //lcd.clear();
            //lcd.print(line_sensor_values[0]);

            if (line_sensor_values[0] < me->line_sensor_threshold) {// sensor 0 is on left
              QACTIVE_POST((QActive *)&AO_Sumo, ON_BOUNDARY_SIG, 0);
            } else if (line_sensor_values[4] < me->line_sensor_threshold) {// sensor 4 is on right
              QACTIVE_POST((QActive *)&AO_Sumo, ON_BOUNDARY_SIG, 0);
            } else if (line_sensor_values[2] < me->line_sensor_threshold) { // sensor 2 is on middle.
              QACTIVE_POST((QActive *)&AO_Sumo, ON_BOUNDARY_SIG, 0);
            } else {
              QACTIVE_POST((QActive *)&AO_Sumo, IN_RING_SIG, 0);
            }
